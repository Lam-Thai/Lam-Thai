        ...
        <div className="mt-20 pt-12 border-t border-zinc-800">
          ...
          <div className="flex flex-wrap gap-4 items-center justify-center">
            {[
              ...
              <div
                key={tech}
                className="px-4 py-2 bg-zinc-900/50 border border-zinc-800 rounded-lg text-zinc-300 text-sm font-medium hover:border-orange-500/50 hover:scale-110 transition-all duration-200"
              >
                {tech}
              </div>
            ))}
