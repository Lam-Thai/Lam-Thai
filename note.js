//file://filehost/<path> - this only in local pc so filehost no needed ///

// after http is the location (server) to look for web server

// change file to http to access other pcs using servers
